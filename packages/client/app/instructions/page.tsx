        ...
        <Box width="100%" color={'black'}>
          ...
          <List spacing={4} alignContent={'center'} textAlign={'center'}>
            <ListItem>
              ...
              <Text as="span" fontWeight="bold" textAlign={'center'} >Describe</Text> - Type or record to describe the accident
            </ListItem>
            <ListItem>
              <ListIcon as={FaMapPin} color="red.400" />
              <Text as="span" fontWeight="bold" textAlign={'center'}>Pin-point</Text> - State when and where the accident happened
            </ListItem>
            <ListItem>
              <ListIcon as={FaLifeRing} color="orange.400" />
              <Text as="span" fontWeight="bold" textAlign={'center'}>Get help</Text> - Obtain an emergency grant for your accident
            </ListItem>
          </List>
        </Box>

        {/* Button */}
        <Button colorScheme="blackAlpha" size="md" rounded="full" width="20%">
          Got it
        </Button>
      </VStack>
    </Center>
