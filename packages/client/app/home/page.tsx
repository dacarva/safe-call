    ...
    <Center height="100vh" bg="white" color={"black"}>
      <VStack spacing={8} width="90%">
        <Flex direction="column" align="center" mt={8}>
          <Image src="/appIcon.png" alt="VoxGuard Logo" boxSize={{ base: "90px", md: "100px" }} />
          <Text fontSize={{ base: "2xl", md: "3xl" }} fontWeight="bold" mt={4}>
            <Text as="span" color="yellow.400">Vox</Text><Text as="span" color="black">Guard</Text>
          </Text>
        </Flex>
        ...
        <VStack spacing={4} align="start" textAlign={'center'}>
          <Flex align="center">
            ...
            <Text fontSize={{ base: "md", md: "lg" }} fontWeight="medium" ml={2}>
        ...
        <Box width={{ base: "80%", md: "40%" }} mt={8} paddingLeft={15} paddingRight={15}>
          <Button
            bg="yellow.400"
            color="white"
            size="lg"
